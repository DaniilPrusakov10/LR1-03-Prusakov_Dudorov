...
async def start_timer(update: Update, context: ContextTypes.DEFAULT_TYPE):
    context.job_queue.run_repeating(send_random_message, interval=10, first=0, chat_id=update.message.chat_id)
...
def main():
    # Создаем объект приложения и указываем токен бота
    ...
    application.add_handler(CommandHandler("add_to_file", add_to_file))  # Без pass_args
